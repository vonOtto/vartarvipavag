...
exports.BEFORE_FINAL_TEMPLATES = exports.QUESTION_INTRO_TEMPLATES = exports.REVEAL_INCORRECT_TEMPLATES = exports.REVEAL_CORRECT_TEMPLATES = exports.BEFORE_REVEAL_TEMPLATES = exports.AFTER_BRAKE_TEMPLATES = exports.BEFORE_CLUE_TEMPLATES = exports.CLUE_TEMPLATES = exports.ROUND_INTRO_TEMPLATES = void 0;
exports.buildClueRead = buildClueRead;
exports.buildQuestionRead = buildQuestionRead;
exports.buildFollowupIntro = buildFollowupIntro;
 ...
 */
function buildClueRead(clueLevel, clueText) {
    const templates = exports.CLUE_TEMPLATES[clueLevel];
...
// ══════════════════════════════════════════════════════════════════════════════
exports.BEFORE_REVEAL_TEMPLATES = [
...
// ══════════════════════════════════════════════════════════════════════════════
exports.REVEAL_CORRECT_TEMPLATES = [
...
exports.REVEAL_INCORRECT_TEMPLATES = [
...
// ══════════════════════════════════════════════════════════════════════════════
exports.QUESTION_INTRO_TEMPLATES = [
    { template: (q) => `Här kommer frågan<break time="700ms"/> ${q}`, slotSuffix: 0 },
    { template: (q) => `Nästa fråga lyder<break time="600ms"/> ${q}`, slotSuffix: 1 },
    { template: (q) => `Lyssna på det här<break time="700ms"/> ${q}`, slotSuffix: 0 },
    { template: (q) => `Okej<break time="400ms"/> frågan blir<break time="600ms"/> ${q}`, slotSuffix: 1 },
    { template: (q) => `Nu blir det svårare<break time="600ms"/> ${q}`, slotSuffix: 0 },
];
function buildQuestionRead(questionText) {
    const variant = exports.QUESTION_INTRO_TEMPLATES[Math.floor(Math.random() * exports.QUESTION_INTRO_TEMPLATES.length)];
    return {
...
// ══════════════════════════════════════════════════════════════════════════════
function buildFollowupIntro(destinationName) {
    const templates = [
...
// ══════════════════════════════════════════════════════════════════════════════
exports.BEFORE_FINAL_TEMPLATES = [
