 ...
 *
 * NOTE: This is a duplicate of services/ai-content/src/script-templates.ts
 * kept in sync manually. Consider moving to a shared package in future.
 *
...
// ══════════════════════════════════════════════════════════════════════════════
// Before Clue — Fyllnadsfraser mellan ledtrådar
// ══════════════════════════════════════════════════════════════════════════════
